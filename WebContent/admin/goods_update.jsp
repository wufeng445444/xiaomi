	...
	<input type="hidden" name="gid" value="${goods.gid }"/>
	    ...
	    <ul class="forminfo">
		    ...
		    <li><label>商品展示图</label>
		    	...
		    	<img src="<%=imgPath%>${goods.pic}"   width="80"  higth="80" />
		    ...
		    <li><label>生产日期</label>
		    	...
		    	<input  value="<fmt:formatDate value="${goods.product_date}"  pattern="yyyy-MM-dd HH:mm:ss"/>" class="Wdate" style="width: 345px;height: 32px;line-height: 32px;" onclick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="product_date" type="text" class="dfinput" value="" />
		    </li>
