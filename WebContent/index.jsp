...
<head>
    <meta charset="UTF-8">
    <title>小米首页</title>
    <link rel="stylesheet" href="${imgPath}css/index.css">
        	...
        	<c:forEach items="${starGoods}" var="goods" >
        	    <!-- 动态数据时使用，已经修改过css -->
				  ...
				  <div style="background-color: #fff;width: 234px;height:320px;float: left;margin-left: 11px; ">
			            	...
			            	<div style="width: 234px;height: 85px;" title="${goods.description }">
			            		...
			            		<div style="width: 234px;height: 35px;line-height: 35px;text-align: center;color: #000;font-size: 14px;font-family: Arial" >
                    	...
                    	<!-- 循环后台取到的家电的集合 -->
                    		...
                    		<!-- 动态获取数据时使用，已经修改过css -->
                   		  ...
                   		  <!-- 	   	第一排4个商品  -->
                  			...
                  			<div style="width: 234px;height: 100px;" title="${goods.description }">
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${goods.gname }</div>
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial" ></div>	
                  				<c:if test="${goods.description.length()<=12}">
                  				${goods.description }
                  				</c:if>
                  				<c:if test="${goods.description.length()>12}">
                  			...
                  			<a href=""><img width="180px" height="180px;" src="<%=imgPath %>${goods.pic}" alt=""></a>
                  			<div style="width: 234px;height: 100px;">
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${goods.gname }</div>
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial" title="${goods.description }"></div>	
                  				<c:if test="${goods.description.length()<=12}">
                  				${goods.description }
                  				</c:if>
                  				<c:if test="${goods.description.length()>12}">
        ...
        <div class="capacity">
            <div class="capa_box_top">
            	...
            	<div class="capa_box scrip_capa_box scrip_capa_box_on">
                	<div class="capa_top">
                	<c:forEach items="${smartGoods}" var="goods">
                		<!-- 智能家居 - 动态使用  -->
	                        ...
	                        <div class="capa_a" title="${goods.description }">
	                            <ul>
        ...
        <div class="capacity">
            ...
            <div class="capa_box">
                <div class="capa_top">
					...
					<!-- 动态数据使用，仅供参考 -->
				<c:forEach items="${tjGoods}" var="goods">
	                	<div class="capa capa_shadow" style="margin-right: 10px;background-color: #fff">
	                        <a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid}"><img width="234"  src="<%=imgPath %>${goods.pic}">
             ...
             <c:forEach items="${hotGoods }" var="goods" varStatus="i">
            		...
            		<c:if test="${i.count ==1 }">
            			<div class="popu popu_unleft popu_shadow" >
	                        <a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid}" target="_blank">
	                        <img style="width: 296px" height="220px" src="<%=imgPath %>${goods.pic}"></a>
